---
title: "GodotNWS: Live U.S. Weather Data for Godot 4.1+"
sidebarTitle: "Introduction"
description: "GodotNWS is a Godot 4.1+ plugin wrapping the U.S. National Weather Service API — live forecasts, alerts, radar, and observations. No API key required."
---
...
GodotNWS exposes thirteen public methods on the `Nws` singleton. The two setup methods must be called first — all fetch methods assert that a location has been configured before making any network requests.
...
Each fetch method emits a corresponding signal when the data is ready:
