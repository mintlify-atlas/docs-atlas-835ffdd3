---
title: "Nws Radar, Chart, and Imagery Methods"
sidebarTitle: "Radar & Imagery"
description: "Reference for GodotNWS imagery methods: radar GIFs, forecast charts, graphicasts, weather stories, radio broadcast text, and national warning and drought maps."
---
...
<ParamField path="index" type="int" required>
  The zero-based index of the graphicast image to fetch. The number of available images varies by NWS office. Start with `0` and increment until requests begin failing.
</ParamField>
...
<Note>
  Graphicast images are produced by the local NWS forecast office (`_office`) and reflect regional weather summaries. Index `0` is the most current image. Not all offices produce the same number of graphicasts.
</Note>
