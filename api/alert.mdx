---
title: "Alert: NWS Weather Alert Data Class"
sidebarTitle: "Alert"
description: "Alert is a Godot Resource containing full NWS weather alert data — severity, urgency, timeline, and message text — delivered via the alerts_fetched signal."
---
